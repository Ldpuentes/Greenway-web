  ...
  return (
    <section className='como-section' ref={rootRef}>
      ...
      <header className='como-hero' data-anim='fade-up'>
        ...
        <p>
          Facilitamos <strong>transacciones seguras</strong>, habilitamos el{' '}
          <strong>acceso a mercados globales</strong> y operamos con{' '}
      ...
      <section className='como-pillars'>
        ...
        <div className='pillars-grid'>
          <article className='pillar' data-anim='fade-left'>
            ...
            <p>
              Procesos definidos de punta a punta para asegurar integridad,
              trazabilidad y evidencia de cada operación.
            </p>
          </article>
          <article className='pillar' data-anim='fade-left' data-delay='80'>
            <h3>Acceso a mercados</h3>
            <p>
              Rutas claras de entrada y operación en mercados internacionales,
              priorizando viabilidad y eficiencia.
            </p>
          </article>
          <article className='pillar' data-anim='fade-left' data-delay='160'>
            <h3>Gestión de riesgo</h3>
            <p>
              Identificación, mitigación y monitoreo continuo del riesgo
              operativo, legal y reputacional.
            </p>
          </article>
          <article className='pillar' data-anim='fade-left' data-delay='240'>
            <h3>Cumplimiento</h3>
            <p>
              Políticas y controles alineados a normativas aplicables, con
              documentación y reportabilidad.
            </p>
          </article>
        </div>
      </section>

      {/* FRANJA DEGRADADA (corta el blanco y crea contraste) */}
      <section className='como-band' data-anim='fade-up' aria-hidden='false'>
        <h3>De la estrategia a la ejecución, sin fricción</h3>
        <p>
          Alineamos objetivos, actores y controles para que cada fase avance con
          evidencia, visibilidad y tiempos claros.
        </p>
      </section>
      ...
      <section className='como-steps'>
        ...
        <div className='steps-grid'>
          <article className='step' data-anim='fade-up'>
            ...
            <p>
              Levantamos objetivo, alcance y contexto: procesos actuales,
              actores, regulaciones y riesgos relevantes.
            </p>
            <ul>
          ...
          <article className='step' data-anim='fade-up' data-delay='60'>
            ...
            <p>
              Definimos la vía de entrada a mercado y el esquema de operación
              segura (roles, hitos, evidencias).
            </p>
            <ul>
          ...
          <article className='step' data-anim='fade-up' data-delay='120'>
            ...
            <p>
              Diseñamos controles, documentación y checklist para contrapartes,
          ...
          <article className='step' data-anim='fade-up' data-delay='180'>
            ...
            <p>
              Activamos la operación (brokeraje / representación) con tableros
              de avance y escalamiento claro.
            </p>
            <ul>
              <li>Hitos y responsables</li>
          ...
          <article className='step' data-anim='fade-up' data-delay='240'>
            ...
            <p>
              Seguimiento continuo con indicadores operativos y de riesgo.
              Trazabilidad y reportes periódicos.
            </p>
            <ul>
          ...
          <article className='step' data-anim='fade-up' data-delay='300'>
            ...
            <p>
              Iteramos sobre procesos, costos y tiempos; ajustamos controles y
              documentación para escalar.
            </p>
            <ul>
      ...
      <section className='como-deliverables'>
        ...
        <div className='cards'>
          ...
          <article className='card' data-anim='pop' data-delay='120'>
            ...
            <p>Hitos, responsables, evidencias y escalamiento.</p>
          </article>
